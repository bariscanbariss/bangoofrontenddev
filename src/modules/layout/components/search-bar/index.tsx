    ...
    <div className="relative flex-1 min-w-0 max-w-2xl lg:mx-8">
      <form onSubmit={handleSearch} className="relative" role="search">
        ...
        <input
          ...
          className="w-full px-3 py-2 pl-10 pr-24 sm:pr-28 rounded-lg border border-gray-300 focus:outline-none focus:border-[#9865e8] focus:ring-2 focus:ring-[#9865e8]/20 transition-all text-gray-900 placeholder:text-gray-500 text-sm"
