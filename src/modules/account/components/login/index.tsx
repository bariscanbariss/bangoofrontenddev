  ...
  return (
    ...
    >
      ...
      <button
        ...
        type="button"
        className="w-full px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg border-2 border-gray-300
                   transition-all duration-300 ease-in-out
                   hover:bg-gray-50 hover:border-gray-400 hover:shadow-lg hover:scale-105
